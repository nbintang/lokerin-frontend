  ...
  return (
    ...
    <>
      ...
      <main className="flex-1 ">
          ...
          <div className="container px-4 md:px-6 relative b  ">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6 bg-clip-text text-transparent bg-gradient-to-r from-foreground to-foreground/70">
                Smart Job Matching with Lokerin
              </h1>
        ...
        <section className="w-full flex items-center justify-center  py-20 md:py-32 bg-muted/30 relative overflow-hidden">
        ...
        <section
          id="pricing"
          className="w-full py-20 flex items-center justify-center md:py-32 bg-muted/30 relative overflow-hidden"
        >
          <div className="absolute inset-0 -z-10 h-full w-full bg-white dark:bg-black bg-[linear-gradient(to_right,#f0f0f0_1px,transparent_1px),linear-gradient(to_bottom,#f0f0f0_1px,transparent_1px)] dark:bg-[linear-gradient(to_right,#1f1f1f_1px,transparent_1px),linear-gradient(to_bottom,#1f1f1f_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_80%_50%_at_50%_50%,#000_40%,transparent_100%)]"></div>
        ...
        <section
          id="faq"
          className="w-full py-20 flex items-center justify-center md:py-32"
        >
          <div className="container px-4 md:px-6">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
        ...
        <section className="w-full py-20 md:py-32 flex items-center justify-center  text-primary-foreground relative overflow-hidden">
          <InteractiveGridPattern
            className={cn(
              ...
              "md:inset-x-[-20%] inset-x-[20%]  inset-y-[-30%] h-[150%] skew-y-12"
            )}
            width={20}
            height={20}
            squares={[80, 80]}
          ...
          <InteractiveGridPattern
            className={cn(
              ...
              "md:[mask-image:radial-gradient(240px_circle_at_center,white,transparent)]",
              "md:inset-x-[20%] inset-x-[-20%] inset-y-[-30%] h-[170%] -skew-y-12 "
            )}
            width={20}
            height={20}
            squares={[80, 80]}
