...
import { AdminSectionsCard } from "@/features/administrator/components/AdminSectionsCard";
...
export default function RecruiterPage() {
      ...
      const { table } = useTable<Recruiter>({
        ...
        data: recruitersQuery.data?.recruiters ?? [],
      });
    return (
  <div className="flex flex-1 flex-col mx-3 md:mx-5 gap-2 py-4  md:gap-4 md:py-6">
         <AdminSectionsCard query={recruitersQuery} />
       ...
       {recruitersQuery.isSuccess && recruitersQuery.data && (
         <>
           ...
           <TablePagination<Recruiter>
             ...
             page={page}
             table={table}
             total={recruitersQuery.data.total}
           />
         </>
       )}
     </div>
